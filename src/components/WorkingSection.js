        ...
        <div className="row">
          ...
          <div className="col-lg-6 d-flex flex-column justify-content-center">
            <div className="working-section-content">
              ...
              <p>
                I am a great a great communicator and love to invest the
                necessary to understand the problem very well, then create the
              ...
              <p>
                My principal workflow stack in web development currently is
                MEVN, but i’m practicing and learning MERN as well.
                <br />
              </p>
              <h4>
                TECH THAT I KNOW
